  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        _PlaylistHeaderButtons(followers: playlist.followers),
      ],
    );
  }
}

class _PlaylistHeaderButtons extends StatelessWidget {
  final String followers;

  const _PlaylistHeaderButtons({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        IconButton(
          onPressed: () => debugPrint('Favorite Button'),
          icon: const Icon(Icons.favorite_border),
          iconSize: 30.0,
        ),
        IconButton(
          onPressed: () => debugPrint('More Button'),
